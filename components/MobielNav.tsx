...
import { mergedSidebarLinks } from '@/constants'
            ...
            <SheetContent side='left' className='border-none bg-dark-1 '>
                <Link href="/" className='flex items-center gap-1'>
                    <Image
                        ...
                        />
                    <p className='text-[26px] font-extrabold text-white '>NTOC HRIS</p>
                </Link>
                <div className='flex h-[calc(100vh-72px)] flex-col justify-between sidebar-content overflow-y-auto'>
                    <SheetClose asChild>
                        <section className='flex h-full flex-col gap-6 pt-16 text-white'>
                            {mergedSidebarLinks.map((link)=>{
